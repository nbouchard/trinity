...
ceDecorators.directive('sideBar', function() {
  return {
      restrict: 'E',
...
ceDecorators.directive('popularArticles', function() {
  return {
      restrict: 'E',
...
ceDecorators.directive('widePopularArticles', function() {
  return {
      restrict: 'E',
...
ceDecorators.directive('blogPosts', function() {
  return {
      restrict: 'E',
...
ceDecorators.directive('featuredArticle', function() {
  return {
      restrict: 'E',
...
ceDecorators.directive('stats', function() {
  return {
      restrict: 'E',
...
ceDecorators.directive('guides', function() {
  return {
      restrict: 'E',
...
ceDecorators.directive('tags', function() {
  return {
      restrict: 'E',
...
ceDecorators.directive('topicSections', function() {
  return {
      restrict: 'E',
