...
function sideNav() {
    ...
    /*
     * Add "sidenav-active" class to body tag when "Menu" nav item
     * is clicked.
     */
    ...
    /*
     * Remove "sidebar-active" class from body tag when clicking
     * anywhere outside of open sidenav.
     */
    ...
    /*
     * Remove "sidebar-active" class from body tag when "Close"
     * link is clicked.
     */
